...
class BestFragment : Fragment() {
    ...
    private fun setBestRV(){
        ...
        var boardList = arrayListOf<BestBoardContents>(
            BestBoardContents(R.drawable.basic_profile_01, "board", "이거 진짜 꿀팁인데 면접할때 떨리잖아? 일단 한 사람 찍어. 그리고", false, 100),
            BestBoardContents(R.drawable.basic_profile_02, "kiking1", "일 처음 하는데 모그렜다\n그냥 물어보는게", true, 0),
        ...
        binding.bestBoardRv.adapter = boardAdapter
